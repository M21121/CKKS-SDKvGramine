// CKKS.h - Modified for benchmarking
#ifndef _CKKS_H_
#define _CKKS_H_
...
public:
    ...
    uint32_t getPolyDegree() const { return params.polyDegree; }
    int64_t* getSecretKey() { return keys.secretKey; }
    int64_t* getPublicKey() { return keys.publicKey; }
};
